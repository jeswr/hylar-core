 ...
 */
export declare function getTermsOfType(terms: RDF.Term[], termType: "NamedNode" | "BlankNode" | "Literal" | "Variable" | "DefaultGraph" | "Quad"): RDF.Term[];
/**
 ...
 */
export declare function getQuads(terms: RDF.Term[]): RDF.BaseQuad[];
