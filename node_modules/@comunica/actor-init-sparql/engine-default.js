const __b16bnode132 = new (require('@comunica/logger-void').LoggerVoid)({});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_join_json_myRdfJoinActorSymmetricHash = new (require('@comunica/actor-rdf-join-symmetrichash').ActorRdfJoinSymmetricHash)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_parsers_json_myRdfParserHtmlMicrodata = new (require('@comunica/actor-rdf-parse-html-microdata').ActorRdfParseHtmlMicrodata)({
...
const __b0bnode322 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': '_:b0bnode322',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize_Bus_RdfSerialize
});
const __b1bnode322 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
...
const __b0bnode316 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': '_:b0bnode316',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
const __b1bnode316 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypeFormats',
  'name': '_:b1bnode316',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_serializers_json_mySparqlCsvSparqlSerializer = new (require('@comunica/actor-sparql-serialize-sparql-csv').ActorSparqlSerializeSparqlCsv)({
  'mediaTypes': {
    'text/csv': '0.75'
  },
  'mediaTypeFormats': {
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_serializers_json_mySparqlTsvSparqlSerializer = new (require('@comunica/actor-sparql-serialize-sparql-tsv').ActorSparqlSerializeSparqlTsv)({
  'mediaTypes': {
