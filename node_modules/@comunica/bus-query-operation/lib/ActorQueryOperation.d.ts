 ...
 */
export declare const KEY_CONTEXT_BGP_CURRENTMETADATA = "@comunica/bus-query-operation:bgpCurrentMetadata";
/**
 ...
 */
export declare const KEY_CONTEXT_BGP_PARENTMETADATA = "@comunica/bus-query-operation:bgpParentMetadata";
/**
 ...
 */
export declare const KEY_CONTEXT_BGP_PATTERNBINDINGS = "@comunica/bus-query-operation:bgpPatternBindings";
/**
 ...
 * @value {any} A metadata hash.
 */
export declare const KEY_CONTEXT_PATTERN_PARENTMETADATA = "@comunica/bus-query-operation:patternParentMetadata";
/**
 * @type {string} Context entry for query's base IRI.
 * @value {any} A string.
 */
export declare const KEY_CONTEXT_BASEIRI = "@comunica/actor-init-sparql:baseIRI";
/**
 * @type {string} A timestamp representing the current time.
 *                This is required for certain SPARQL operations such as NOW().
 * @value {any} a date.
 */
export declare const KEY_CONTEXT_QUERY_TIMESTAMP = "@comunica/actor-init-sparql:queryTimestamp";
/**
 ...
 */
export declare type IActorQueryOperationOutput = IActorQueryOperationOutputStream | IActorQueryOperationOutputQuads | IActorQueryOperationOutputBoolean;
 ...
 */
export declare type IPatternBindings = Record<string, RDF.Variable>;
