const __b16bnode147 = new (require('@comunica/logger-void').LoggerVoid)({});
...
const __b0bnode310 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': '_:b0bnode310',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
const __b1bnode310 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypeFormats',
  'name': '_:b1bnode310',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_serializers_json_myRdfSparqlSerializer = new (require('@comunica/actor-sparql-serialize-rdf').ActorSparqlSerializeRdf)({
  ...
  'mediatorMediaTypeCombiner': __b0bnode312,
  'mediatorMediaTypeFormatCombiner': __b1bnode312,
...
const urn_comunica_sparqlinit = new (require('@comunica/actor-init-sparql').ActorInitSparql)({
  ...
  'mediatorSparqlSerializeMediaTypeCombiner': __b0bnode310,
  'mediatorSparqlSerializeMediaTypeFormatCombiner': __b1bnode310,
