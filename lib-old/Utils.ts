...
export function getValueFromDatatype (datatype) {
  const rawValueMatch = datatype.match(RegularExpressions.LITERAL_RAW_VALUE)[1]; const literalWithoutTypeMatch = datatype.match(RegularExpressions.LITERAL_WITHOUT_TYPE)[1]
